...
How It Works
Import student data by copying from Google Sheets and pasting into the input area.
Map columns such as Name and Department.
Add exam rooms along with their seating capacity.
Choose seating preferences (e.g., separate same-department students).
Generate the seating plan using available algorithms.
View results visually and export if needed.
